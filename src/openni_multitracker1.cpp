...
void publishTransforms(const std::string& frame_id) {
    ...
    for (int i = 0; i < users_count; ++i) {
        ...
        publishTransform(user, XN_SKEL_HEAD,           frame_id, "head1");
        publishTransform(user, XN_SKEL_NECK,           frame_id, "neck1");
        publishTransform(user, XN_SKEL_TORSO,          frame_id, "torso1");

        publishTransform(user, XN_SKEL_LEFT_SHOULDER,  frame_id, "left_shoulder1");
        publishTransform(user, XN_SKEL_LEFT_ELBOW,     frame_id, "left_elbow1");
        publishTransform(user, XN_SKEL_LEFT_HAND,      frame_id, "left_hand1");

        publishTransform(user, XN_SKEL_RIGHT_SHOULDER, frame_id, "right_shoulder1");
        publishTransform(user, XN_SKEL_RIGHT_ELBOW,    frame_id, "right_elbow1");
        publishTransform(user, XN_SKEL_RIGHT_HAND,     frame_id, "right_hand1");

        publishTransform(user, XN_SKEL_LEFT_HIP,       frame_id, "left_hip1");
        publishTransform(user, XN_SKEL_LEFT_KNEE,      frame_id, "left_knee1");
        publishTransform(user, XN_SKEL_LEFT_FOOT,      frame_id, "left_foot1");

        publishTransform(user, XN_SKEL_RIGHT_HIP,      frame_id, "right_hip1");
        publishTransform(user, XN_SKEL_RIGHT_KNEE,     frame_id, "right_knee1");
        publishTransform(user, XN_SKEL_RIGHT_FOOT,     frame_id, "right_foot1");
    }
}
